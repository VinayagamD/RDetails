    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-right" id="navbarmain">
            <ul class="nav navbar-nav">
                <li class="active"><a href="<c:url value="login.jsp"/>"><i class="fa fa-user">&nbsp;Login</i></a></li>
                <li><a href="<c:url value="signup.jsp"/>"><i class="fa fa-user-plus">&nbsp;Register</i></a></li>
                ...
                <div class="panel-body">
                    <form action="login" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="username" placeholder="UserName" name="<%=RDetailsConstants.USER_NAME%>">
                        </div>
                        <div class="form-group">
                            <label for="password"><i class="fa fa-lock">&nbsp;Password</i></label>
                            <input type="password" class="form-control" id="password" placeholder="Password" name="<%=RDetailsConstants.PASSWORD%>">
                        </div>
